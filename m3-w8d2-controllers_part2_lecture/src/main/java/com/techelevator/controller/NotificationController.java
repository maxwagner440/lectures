...
public class NotificationController {
	...
	public String processNotificationSignupSubmission(@ModelAttribute Notification note) throws FileNotFoundException, IOException {
		...
		try(FileOutputStream out = new FileOutputStream(getSignupLogFile(), true)) {
			...
			log.saveNotificationSignup(note);
		}
		 ...
		 * "redirect:" is treated as a RequestMapping and not a full URL. */
