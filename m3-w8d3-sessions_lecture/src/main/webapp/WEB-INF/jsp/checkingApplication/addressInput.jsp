...
<form method="POST" action="${addressInputUrl}">
	...
	<div class="formInputGroup">
		<label for="addressApartment">Apartment / Suite Number:</label> 
		<input type="text" name="addressApartment" id="addressApartment" />
	</div>
	<div class="formInputGroup">
	...
	<div class="formInputGroup">
		...
		<input type="text" name="addressZip" id="addressZip" />
	</div>
